...
<section class="ftco-section bg-light">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            <h2 >New Arrival</h2>
            <p>
			  Provide engaging descriptions of the new items.
		      We have a new items here are some pictures you cen see and buy it.
			</p>
          </div>
        </div>   		
    	</div>
...
$query = " SELECT `name`, `img`, `price`, `discount`,`description` FROM `sopping-cart-index`  order by id ASC ";
...
if($num > 0){
  ...
  <div class="col-lg-3 col-md-3 col-sm-12 ">
    ...
    <form>
      <div class="card">
        <h6 class="card-title bg-dark text-white h4 p-2 mx-2 my-2 text-uppercase"> <?php echo $product['name'];  ?> </h6>
        ...
        <div class=" btn-group d-flex">
          <button class=" btn btn-dark  mx-2 my-3 px-4 py-3"><a href="wishlist.php"class="h4 text-light">Add to cart</a></button> 
...
?>
 ...
 <button class="btn btn-primary py-3 pt-3 px-3" style="margin-left:45%; margin-top:3rem;">
